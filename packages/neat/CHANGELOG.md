# Change Log - @neat-evolution/neat
...
- optimize createPhenotype to build nodeMapping directly; adopt refined AlgorithmContext-based generics; adopt AlgorithmContext-based generics (github@heygrady.net)
...
- optimize NEATGenome initialization and serialization (github@heygrady.net)
