# Change Log - @neat-evolution/cppn
...
- pass createGenome factory to CPPNGenome constructor in benchmark; extract mutateNodeSelection helper and optimize createPhenotype; adopt refined AlgorithmContext-based generics; adopt AlgorithmContext-based generics (github@heygrady.net)
...
- optimize CPPNGenome initialization and serialization (github@heygrady.net)
...
- apply Biome formatting and update test fixtures (github@heygrady.net)
...
- Pass populationFactoryOptions through algorithm packages (github@heygrady.net)
