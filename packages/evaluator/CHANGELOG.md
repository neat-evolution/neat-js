...
- refactor Evaluator API for better performance and type safety (github@heygrady.net)
...
- Simplify Evaluator interface and migrate to evaluation-strategy (github@heygrady.net)
